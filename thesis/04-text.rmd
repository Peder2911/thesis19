...
whether a text can be said to _contain_ the information sought in any
...
relevant for coding the start of a ceasefire, as does not point to an
...
might reasonably be related to several kinds of information at once
...
of this true set: We might only be able to observe some true events, or we
might observe reported events that did not in fact occur.
